...
POST /policies/<id>/resource/activities
POST /activities/<id>/resource/activities
...
```http
POST https://graph.microsoft.com/beta/providers('00000000-0000-0000-0000-000000000002')/resources/<id>/activities
```
...
<!-- {
  ...
  "description": "resource: activities",
  "keywords": "",
