...
PATCH /policies/<id>/roleDefinitions/<id>
PATCH /providers/<id>/roleDefinitions/<id>
```
...
```http
PATCH https://graph.microsoft.com/beta/providers('00000000-0000-0000-0000-000000000002')/roleDefinitions/<id>
