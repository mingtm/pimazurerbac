...
<!-- { "blockType": "ignored" } -->
```http
GET /policies/<id>/roleDefinitions
GET /providers/<id>/policies/<id>/roleDefinitions
```
...
```http
GET https://graph.microsoft.com/beta/providers('00000000-0000-0000-0000-000000000002')/policies/<id>/roleDefinitions
```
##### Response
